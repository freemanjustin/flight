/*
	...
	Authors:
		Justin Freeman (J.Freeman@bom.gov.au)

	$Author: jfreeman $
	$Date: 2011-09-20 15:07:39 +1000 (Tue, 20 Sep 2011) $
	$Revision: 719 $

	
	$Id: jutil.c 719 2011-09-20 05:07:39Z jfreeman $
*/
...
double ****malloc4d_double(int dim1, int dim2, int dim3, int dim4)
{
	...
	double 	*raw_bytes = malloc(layers_size + data_size);
...
float ***malloc3d_float(int dim1, int dim2, int dim3)
{
	...
	float 	*raw_bytes = malloc(layers_size + data_size);
...
int ***malloc3d_int(int dim1, int dim2, int dim3)
{
	...
	int 	*raw_bytes = malloc(layers_size + data_size);
...
short int ***malloc3d_short(int dim1, int dim2, int dim3)
{
	...
	short int 	*raw_bytes = malloc(layers_size + data_size);
...
signed char ***malloc3d_char(int dim1, int dim2, int dim3)
{
	...
	signed char 	*raw_bytes = malloc(layers_size + data_size);
